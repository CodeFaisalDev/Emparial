  ...
  return (
    <PageTransition>
      <div className="pt-32 pb-16">
        {/* Header Title */}
        <Reveal className="px-4 max-w-[1600px] mx-auto mb-12">
        ...
        {/* Massive Hero Image */}
        <Reveal delay={0.2} className="px-4 max-w-[1600px] mx-auto mb-20">
        ...
        <div className="px-4 max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 mb-32">
          ...
          <div className="lg:col-span-4">
            <Reveal className="sticky top-40 bg-white rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-10 text-navy">
          ...
          <div className="lg:col-span-8">
            <Reveal delay={0.1} className="bg-white rounded-[1.5rem] md:rounded-[2.5rem] p-6 md:p-10 lg:p-16 text-navy h-full">
        ...
        <div className="px-4 max-w-[1600px] mx-auto mb-32">
          <Reveal className="text-2xl md:text-3xl font-bold mb-6 md:mb-10 tracking-tight text-white px-4">Gallery</Reveal>
        ...
        {/* Next Project Banner */}
        <Reveal className="px-4 max-w-[1600px] mx-auto mb-16">
